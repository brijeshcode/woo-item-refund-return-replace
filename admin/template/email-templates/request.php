...
<h2 class=""><?php _e('Request templates' , 'wc-item-actions'); ?> </h2>
<div class="row">
        ...
        <form method="post" class="mt-2">
            ...
            <div class="eidtor w-95 mb-2">
                ...
                <?php
                    ...
                    $editorHtmlId = 'requested_template_id';
                    $options = [
